...
for (typeof(collection) __collection__ = collection;; )                                                                        \
for (;; ({ break; }))                                                                                                          \
for (iterator(name)(__collection__) iterator_name = iterator_make(name)(__collection__); iterator_next(name)(iterator_name);)  \
